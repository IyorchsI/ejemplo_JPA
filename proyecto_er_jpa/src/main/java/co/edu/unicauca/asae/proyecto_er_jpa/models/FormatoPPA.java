...
public class FormatoPPA extends FormatoA {
    ...
    public FormatoPPA(String titulo_formato, String nombre_director,String objetivo_general,String objetivos_especificos,String nombre_estudiante1,
     Estado objEstado, List<Evaluacion> evaluaciones, Docente objDocente,String nombre_asesor,String ruta_carta_aceptacion){
        super(titulo_formato, nombre_director, objetivo_general, objetivo_general, nombre_estudiante1, objEstado, evaluaciones, objDocente);
