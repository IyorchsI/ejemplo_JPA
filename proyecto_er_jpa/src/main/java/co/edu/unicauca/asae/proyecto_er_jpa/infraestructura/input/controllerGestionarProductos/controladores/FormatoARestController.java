...
public class FormatoARestController {
        ...
        public ResponseEntity<List<FormatoADTORespuesta>> consultarPorDocente(
                        @Min(value = 1) @PathVariable Integer idDocente) {
                ...
                for (FormatoA formato : formatos) {
                        if (formato instanceof FormatoPPA) {
                                formatosRespuesta.add(
                                                objMapeadorPPA.mappearDeFormatoPPARespuesta(((FormatoPPA) formato)));
                        } else {
                                formatosRespuesta.add(
                                                objMapeadorTIA.mappearDeFormatoTIARespuesta(((FormatoTIA) formato)));
                        }
                }
        ...
        public ResponseEntity<List<FormatoADTORespuesta>> consultarPorFechaIdDocente(
                ...
                List<FormatoA> formatos = objGestionarFormatoACUInt.buscarFormatoADocentePorFecha(idDocente,
